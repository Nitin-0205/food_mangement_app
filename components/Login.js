        ...
        <View style={styles.LogMain}>
            ...
            <View style={styles.logContainer}>
                ...
                <View>
                    ...
                    <View style={{ height: 45, marginBottom: 25, flexDirection: "row", backgroundColor: "white", width: 250, borderColor: "#4488D8", borderWidth: 2, borderRadius: 3 }}>
                        <TextInput style={{ paddingHorizontal: 10, paddingVertical: 6, fontSize: 15, flexGrow: 1, backgroundColor: "white", borderRadius: 5 }} placeholder="" secureTextEntry={passVisible} value={userdetail.password} onChangeText={(txt) => { setuserdetail({ ...userdetail, password: txt }) }}></TextInput>
